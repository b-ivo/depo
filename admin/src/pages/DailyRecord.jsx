...
function DailyRecord() {
  ...
  async function handleStartDay() {
    try {
      ...
      if (
        ...
        setStartError(msg || "Failed to start business day.");
      }
    } finally {
      setStarting(false);
    }
  ...
  if (loading) {
    return (
      <AppLayout title="Daily Record" description="Manage today's stock and sales" activePath="/admin/daily">
    ...
    return (
      <AppLayout title="Daily Record" description="Manage today's stock and sales" activePath="/admin/daily">
        <div className="rounded-xl border border-slate-200 bg-white p-8 text-center shadow-sm">
          ...
          <h2 className="mt-4 text-xl font-semibold text-slate-900">Business Day Closed</h2>
          <p className="mx-auto mt-2 max-w-md text-sm text-slate-500">
            Today's business day has already been completed. Review the record in History.
          </p>
          <a
            href="/admin/history"
    ...
    return (
      <AppLayout title="Daily Record" description="Manage today's stock and sales" activePath="/admin/daily">
        <div className="rounded-xl border border-slate-200 bg-white p-8 text-center shadow-sm">
          ...
          <h2 className="mt-4 text-xl font-semibold text-slate-900">Business Day Not Started</h2>
          <p className="mx-auto mt-2 max-w-md text-sm text-slate-500">
    ...
    return (
      <AppLayout title="Daily Record" description="Manage today's stock and sales" activePath="/admin/daily">
        <div className="rounded-xl border border-red-200 bg-red-50 p-6">
          <h2 className="font-semibold text-red-800">Unable to load today's record</h2>
